...
class CustomFormTextField extends StatefulWidget {
   CustomFormTextField( {super.key, required this.hint, required this.keyboardType, this.eyeIconIsVisible =false, this.onSaved });
  final String hint;
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: widget.eyeIconIsVisible
